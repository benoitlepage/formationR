...
De nombreuses ressources sont disponibles pour vous aider à utiliser R : 
  ...
  - Des fiches "mémoires" _cheat sheets_ qui résument les principales fonctions : 
    ...
    - méthodes de manipulation de données avec le package [tidyr](https://rstudio.github.io/cheatsheets/html/tidyr.html)
    - méthodes de transformation de données avec le package [dplyr](https://rstudio.github.io/cheatsheets/html/data-transformation.html)
