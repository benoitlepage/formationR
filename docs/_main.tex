...
\FunctionTok{length}\NormalTok{(vect\_int) }\CommentTok{\# vecteur de longeur 5}
\FunctionTok{length}\NormalTok{(vect\_new) }\CommentTok{\# vecteur de longeur 8}
\FunctionTok{length}\NormalTok{(vect\_char) }\CommentTok{\# vecteur de longeur 6}
\FunctionTok{length}\NormalTok{(vect\_logic) }\CommentTok{\# vecteur de longeur 8}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# 1er élément avec 1er élément TRUE \& TRUE = TRUE}
\CommentTok{\# 2ème élément avec 1er élément TRUE \& FALSE = FALSE}
\CommentTok{\# 3ème élément avec 1er élément FALSE \& TRUE = FALSE}
\CommentTok{\# 4ème élément avec 1er élément FALSE \& FALSE = FALSE}

\FunctionTok{c}\NormalTok{(}\ConstantTok{TRUE}\NormalTok{, }\ConstantTok{TRUE}\NormalTok{, }\ConstantTok{FALSE}\NormalTok{, }\ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{|} \FunctionTok{c}\NormalTok{(}\ConstantTok{TRUE}\NormalTok{, }\ConstantTok{FALSE}\NormalTok{, }\ConstantTok{TRUE}\NormalTok{, }\ConstantTok{FALSE}\NormalTok{)}
\CommentTok{\# TRUE  TRUE  TRUE FALSE}
\CommentTok{\# 1er élément avec 1er élément TRUE | TRUE = TRUE}
\CommentTok{\# 2ème élément avec 1er élément TRUE | FALSE = TRUE}
\CommentTok{\# 3ème élément avec 1er élément FALSE | TRUE = TRUE}
\CommentTok{\# 4ème élément avec 1er élément FALSE | FALSE = FALSE}
\end{Highlighting}
\end{Shaded}
