...
Il est également possible d'utiliser la fonction `subset()`, qui prend pour arguments `subset =` avec des conditions pour sélectionner des lignes, et `select = ` pour sélectionner des colonnes.
