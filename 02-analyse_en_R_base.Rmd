...
```{r view2, eval=FALSE, include=TRUE}
...
length(which(!is.na(df_1miss$imc))) # 300
...
On peut également lancer une fonction de manière répétée appliquée :
  ...
  - à des vecteurs ou des listes avec `lapply()` (qui retourne les résultats sous forme de liste) ou `sapply()` (qui retournent les résultats sous forme "simplifiée" de matrice ou de vecteur)
...
```{r multi3, eval=FALSE, include=TRUE}
